    ...
    */
    ...
    func makeToastActivity(position pos: AnyObject, message msg: String = "") {
        ...
        if (!msg.isEmpty){
            ...
            activityMessageLabel.font = (msg.characters.count<=10) ? UIFont(name:activityMessageLabel.font.fontName, size: 15) : UIFont(name:activityMessageLabel.font.fontName, size: 13)
